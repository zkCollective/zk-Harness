...
async function run () {
    ...
    if (!fs.existsSync(path_name)) {
        result_string = "framework,category,curve,field,operation,input,ram,time,nbPhysicalCores,nbLogicalCores,machine\n";
    }
    ...
    result_string += "circom,arithmetics," + curve_name + "," + field_name + "," + operation + "," + ram + "," + elapsed + ",1,1," + machine + "\n";
